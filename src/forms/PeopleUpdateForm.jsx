      ...
      className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl py-10 px-9 mx-auto w-[90%] md:max-w-2xl hover:-translate-y-2 transition-all duration-300">
        ...
        <form className="flex flex-col gap-5">
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-[#3DBAF3] to-[#07689F] text-white py-3 rounded-lg hover:opacity-90 hover:-translate-y-1 transition duration-500 shadow-md shadow-[#1a80b0] hover:cursor-pointer"
          >

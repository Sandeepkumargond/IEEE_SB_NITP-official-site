        ...
        <div className="mx-auto w-full max-w-[1300px] py-[10px] flex flex-col justify-between gap-[15px]">
          ...
          <div className="flex flex-col items-center md:flex-row md:justify-between md:items-start">
            ...
            <div className="hidden md:flex space-x-6 text-[16px] font-medium md:mt-1">
              <a href="#" className="hover:underline">About IEEE</a>
              <a href="#" className="hover:underline">IEEE Renew</a>
              <a href="#" className="hover:underline">IEEE Xplore</a>
              <a href="#" className="hover:underline">IEEE Membership</a>
            </div>
          </div>
      <p className="hidden md:block md:text-[16px]">
               National Institute of Technology Patna,Bihar (800005), India
              </p>
              <p className="md:hidden text-[12px] flex flex-col justify-center items-center">
                <div>
        ...
        Bihar (800005), India
          ...
          <div className="border-t border-gray-400 pt-4 text-center text-[12px] md:text-sm">
            © 2024 <a href="#" className="underline">IEEE SB NITP</a>. All Rights Reserved.
          </div>
        </div>
      </div>
    </footer>
